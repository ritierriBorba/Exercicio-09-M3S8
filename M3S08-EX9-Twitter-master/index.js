const getInitials = (name) => {
    if (name !== "") {
        ...
        const lastLetter = splittedName[splittedName.length - 1][0].
        toUpperCase()
...
let username = prompt("Entre com seu nome de usuário:")
...
body.style.backgroundColor = "#40647A"

const form = document.createElement("form")
form.style.boxShadow = "1px 1px 10px 0px rgba(0,0,0,0.5)"
form.style.backgroundColor = "#A3B9C7"
...
textLabel.innerHTML = "O que está acontecendo?"
...
submitBtn.style.backgroundColor = "#2DC0ED"
submitBtn.style.color = "#FFFFFF"

const textArea = document.createElement("textarea")
textArea.setAttribute("id", "tweetbox")
textArea.setAttribute("rows", "4")
textArea.style.backgroundColor = "#F7F9F9"
...
const appendTweet = (tweet) => {
    ...
    newTweet.style.boxShadow = "1px 1px 10px 0px rgba(0,0,0,0.5)"
    newTweet.style.backgroundColor = "#CDE9FA"
    ...
    tweetAvatar.style.backgroundColor = "#3B676E"
    ...
    likeBtn.style.backgroundColor = "#2DC0ED"
